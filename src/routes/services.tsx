...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Full-spectrum technology services from Uplayers Talent." },
      { property: "og:url", content: "https://uplayersrecruit.in/services" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://uplayersrecruit.in/services" }],
  }),
